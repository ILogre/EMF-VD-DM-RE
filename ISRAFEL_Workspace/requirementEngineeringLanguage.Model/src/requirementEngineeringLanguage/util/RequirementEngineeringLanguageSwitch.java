 ...
 * @generated
 */
public class RequirementEngineeringLanguageSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public RequirementEngineeringLanguageSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RequirementEngineeringLanguagePackage.SCENARIO: {
				Scenario scenario = (Scenario)theEObject;
				T result = caseScenario(scenario);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementEngineeringLanguagePackage.GIVEN: {
				Given given = (Given)theEObject;
				T result = caseGiven(given);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementEngineeringLanguagePackage.WHEN: {
				When when = (When)theEObject;
				T result = caseWhen(when);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementEngineeringLanguagePackage.THEN: {
				Then then = (Then)theEObject;
				T result = caseThen(then);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementEngineeringLanguagePackage.LOADING: {
				Loading loading = (Loading)theEObject;
				T result = caseLoading(loading);
				if (result == null) result = caseWhen(loading);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementEngineeringLanguagePackage.INTERACTION: {
				Interaction interaction = (Interaction)theEObject;
				T result = caseInteraction(interaction);
				if (result == null) result = caseWhen(interaction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementEngineeringLanguagePackage.VIEW: {
				View view = (View)theEObject;
				T result = caseView(view);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementEngineeringLanguagePackage.PROJECT: {
				Project project = (Project)theEObject;
				T result = caseProject(project);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementEngineeringLanguagePackage.UPDATE: {
				Update update = (Update)theEObject;
				T result = caseUpdate(update);
				if (result == null) result = caseThen(update);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementEngineeringLanguagePackage.GOAL: {
				Goal goal = (Goal)theEObject;
				T result = caseGoal(goal);
				if (result == null) result = caseThen(goal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementEngineeringLanguagePackage.FEATURE: {
			...
			case RequirementEngineeringLanguagePackage.DATA: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Loading</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Loading</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLoading(Loading object) {
		return null;
	}
...
} //RequirementEngineeringLanguageSwitch
